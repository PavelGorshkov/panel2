...
?>
    <aside class="control-sidebar control-sidebar-dark">
        ...
        <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
            <li><a href='#control-sidebar-theme-options-tab' data-toggle='tab'><i class='fa fa-paint-brush'></i></a>
            </li>
        ...
        <div class="tab-content">
            <!-- Skins tab content -->
            <div class="tab-pane active" id="control-sidebar-theme-options-tab"><?php include '_tab_skins.php'; ?></div>
            <!-- /.tab-pane -->
            <!-- Home tab content -->
