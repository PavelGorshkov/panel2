...
class Generator extends DevGenerator
{
     ...
     */
    public $baseClass = 'app\modules\core\components\WebController';
    /**
    ...
    public $existsActionsMethod = false;

    public $titleClass;


    protected $baseClassList = [
        '\app\modules\core\components\WebController',
        '\app\modules\core\components\RedactorController',
    ];
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['controllerClass', 'actions', 'baseClass', 'taskClass', 'module'], 'filter', 'filter' => 'trim'],
            ...
            ['baseClass', 'in', 'range'=>$this->getBaseClassList()],
            ...
            [['viewPath', 'titleClass'], 'safe'],
            ['existsActionsMethod', 'boolean'],
     ...
     * @return array
     */
    public function getBaseClassList() {
    ...
    public function attributeLabels()
    {
        return [
            ...
            'viewPath' => 'View Path',
            'actions' => 'Action IDs',
            'existsActionsMethod' => 'Exists method actions()',
            'titleClass' => 'Controller Title',
        ];
    }
    ...
    public function hints()
    {
        return [
            ...
            'titleClass' => 'This is the header of the controller class being created, which is used in the <code> setTitle () </code> method and <code> getTitle () </code>',
            ...
            'viewPath' => 'Specify the directory for storing the view scripts for the controller. You may use path alias here, e.g.,
                ...
                to <code>@app/modules/<moduleID>/views/ControllerID</code>',
            'taskClass'=>'This class participates in the AccessControl authorization filters. Please make sure the class exists and can be autoloaded.',
